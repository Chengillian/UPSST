...
# ################ Path setting
data_root = r'C:\cgy\datasets\10X_data\STARmap\annotation'
data_name = 'STARmap'
...
file_fold = os.path.join(data_root,'STARmap_20180505_BY3_1k.h5ad')
# ################## Load data
adata_h5 = sc.read(file_fold)
...
sc.pl.spatial(adata_sedr, img_key="hires", color=['SEDR_leiden'], show=False,spot_size=60.0)
...
ARI = metrics.adjusted_rand_score(adata_h5.obs['label'],adata_sedr.obs['SEDR_leiden'])
