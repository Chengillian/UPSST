...
BASE_PATH = Path(r'C:\cgy\datasets\10X_data')
output_path = Path(r'C:\cgy\all_methods\spagcn_results\\')
sample_name='V1_Breast_Cancer_Block_A_Section_1'
...
img=cv2.imread(f"{dir_input}/full_image.tif")
#Set coordinates
...
# res=spg.search_res(adata, adj, l, n_clusters, start=1.5, step=0.1, tol=5e-5, lr=0.05, max_epochs=20, r_seed=r_seed, 
